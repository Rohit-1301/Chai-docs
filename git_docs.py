...
- If the user asks about Git commands, refer to the commands section and provide the exact URL
- If the user asks about Git workflows, refer to the workflows section and provide the exact URL

Example of how to format source references:
Source: Introduction to Git (https://docs.chaicode.com/youtube/chai-aur-git/introduction/)
- Lines 15-20: Basic Git concepts explanation
- Lines 45-50: Git repository setup example
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_input.lower() == 'exit':
            print("\nThank you for using Git Tutor. Goodbye!")
            break
